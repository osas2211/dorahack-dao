  ...
  return (
    <div className="relative">
      <div className="sticky w-full top-12 md:top-8 left-0 z-[10] bg-surface dark:bg-surface-dark">
        ...
        <div className="grid xl:grid-cols-[55%,1fr,1fr,1fr,1fr] rounded-md lg:grid-cols-[40%,1fr,1fr,1fr,1fr] grid-cols-2 lg:gap-0 gap-1 lg:h-[56px] h-auto border-outline-variant dark:border-outline-variant-dark lg:border-[1px]">
